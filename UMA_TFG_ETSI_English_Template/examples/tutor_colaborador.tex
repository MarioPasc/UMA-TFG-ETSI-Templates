...
\usepackage{template/sty_files/colaborador_cover-blueuma}
\usepackage{template/sty_files/colaborador_cover-whiteuma}
...
%────────────────────── Blue front cover (Colaborador) ───────────────────────
\MakeColabBlueUMACover{
...
%────────────────────── White front cover (Colaborador) ───────────────────────
\MakeColabWhiteUMACover{
